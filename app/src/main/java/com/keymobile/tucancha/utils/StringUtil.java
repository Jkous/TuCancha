...
public final class StringUtil {
    ...
    public static String stringify(FetchPlaceResponse response, boolean raw) {
        StringBuilder builder = new StringBuilder();
    ...
    public static String stringify(FindCurrentPlaceResponse response, boolean raw) {
        StringBuilder builder = new StringBuilder();
    ...
    public static String stringify(Place place) {
